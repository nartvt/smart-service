...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.HashPassword(); !ok {
		return &ValidationError{Name: "hash_password", err: errors.New(`ent: missing required field "User.hash_password"`)}
	}
	if v, ok := uc.mutation.HashPassword(); ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.HashPassword(); ok {
		_spec.SetField(user.FieldHashPassword, field.TypeString, value)
		_node.HashPassword = value
	}
